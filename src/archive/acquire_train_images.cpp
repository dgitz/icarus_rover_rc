...
void mouseCallBack(int event, int x, int y, int flags, void* userdata)
{
     if  ( event == cv::EVENT_LBUTTONDOWN )
     {
          ...
          image_counter++;
          ostringstream tempconvert;
          tempconvert << image_counter;
          image_filename = root_directory + "media/imagesamples-" + capture_date + "/Image" + tempconvert.str() + ".png";  //Wrong
...
int main(int argc, char **argv)
{
  ...
  string tempstr = root_directory + "media/imagesamples-" + capture_date;

  mkdir(tempstr.c_str(),S_IRWXU | S_IRWXG | S_IROTH | S_IXOTH);
  ROS_INFO("%s",capture_date.c_str());
